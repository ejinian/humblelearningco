...
export default function Home() {
  return (
    <div>
      <Helmet>
        <title>5-Star Private Tutor in Los Angeles | HUMBLE Learning Co.</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="5-Star Private Tutor in Los Angeles | HUMBLE Learning Co." />
        <meta
