...
export default function Home() {
  return (
    <div>
      <Helmet>
        <title>Best Private Tutoring in Los Angeles | HUMBLE Learning Co.</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Best Private Tutoring in Los Angeles | HUMBLE Learning Co." />
        <meta
